...
function createImg(imgName) {
	...
	if(mq.matches){
        ...
        document.getElementById("photos2").appendChild(div);
	}
	return image;
...
function showUploadOptions2() {
	var div = document.getElementById("uploadOptions2");
	if(div.style.display == "block") {
		div.style.display = "none";
	} else {
		div.style.display = "block";
...
function showFilterOptions2() {
	var div = document.getElementById("filterOptions2");
	if(div.style.display == "block") {
		div.style.display = "none";
	} else {
		div.style.display = "block";
...
function filterFavorites2() {
	var div = document.getElementById("favoritesOptions2");
	div.style.display = "block";
	var url = "http://138.68.25.50:"+PORT_NO+"/query?op=getFavs";
	function reqListener() {
		var data = JSON.parse(this.responseText);
...
function clearFavsFilter2() {
	var photos = document.getElementsByClassName("photo2");
	for(var i = 0; i < photos.length; i++) {
		photos[i].style.display = "block";
	}
	var div = document.getElementById("favoritesOptions2");
